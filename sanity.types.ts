...
// Query: *[    _type == "product"    ] | order(new asc)
...
// Query: *[     _type == "product"     && references(*[_type == "category" && slug.current == $categorySlug]._id)   ] | order(new asc)
...
// Query: *[     _type == "product"     && name match $searchParams   ] | order(new asc)
