...
const AddToBasketButton = ({ product, disabled }: AddToBasketButtonProps) => {
  ...
  // preventing hydration errors due to server/client mismatche
  ...
  return (
    <div className="flex items-center justify-center space-x-2">
      <button
        ...
        className={`w-8 h-8 rounded-full flex items-center justify-center transition-colors duration-200 ${itemCount === 0 ? "bg-gray-100 cursor-not-allowed" : "bg-gray-200 text-white hover:bg-gray-300"}`}
